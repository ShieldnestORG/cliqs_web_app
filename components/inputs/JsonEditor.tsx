...
const editorStyle: { [key: string]: string } & CSSProperties = {
  ...
  "--jse-delimiter-color": "hsl(var(--foreground))",
  "--jse-key-color": "hsl(var(--foreground))",
  "--jse-text-color": "hsl(var(--foreground))",
  "--jse-value-color": "hsl(var(--foreground))",
  "--jse-value-color-boolean": "hsl(var(--foreground))",
  "--jse-value-color-null": "hsl(var(--foreground))",
  "--jse-value-color-number": "hsl(var(--foreground))",
  "--jse-value-color-string": "hsl(var(--foreground))",
  "--jse-value-color-url": "hsl(var(--foreground))",
